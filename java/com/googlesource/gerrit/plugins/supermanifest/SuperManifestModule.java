  ...
  protected void configure() {
    ...
    install(
        new FactoryModuleBuilder()
            .implement(
                SuperManifestRefUpdatedListener.GerritRemoteReader.class,
                SuperManifestRefUpdatedListener.GerritRemoteReaderImpl.class)
            .build(SuperManifestRefUpdatedListener.GerritRemoteReader.Factory.class));
